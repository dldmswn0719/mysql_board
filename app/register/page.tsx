...
export default function Register(){
    ...
    return(
        <>
            ...
            <div className="flex bg-[#f5f5f5] justify-center h-[calc(100vh-136px)] items-center">
                <div className="w-[35vw] p-5 shadow-[0px_0px_10px_rgba(0,0,0,0.1)] bg-white rounded-xl">
