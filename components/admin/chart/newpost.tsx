            ...
            <div className="mt-5 md:mt-0 basis-full md:basis-[49.3%]">
                <div className="widget mb-5">
                    ...
                    <div className="w-full">
                        <ul className="flex py-4 text-sm justify-between border-b bg-[#f6f9fc]">
                            <li className="basis-[33%] text-[#6f809a] font-bold text-center text-xd sm:text-sm">작성자</li>
                            <li className="basis-2/5 text-[#6f809a] font-bold text-center text-xd sm:text-sm">제목</li>
                            <li className="basis-1/5 text-[#6f809a] font-bold text-center text-xd sm:text-sm">작성일</li>
                        </ul>
                        {
                                ...
                                return(
                                    <>
                                        <ul key={i} className="flex justify-between border-b last:border-0 items-center">
                                            <li className="basis-[33%] text-[#6f809a] font-bold text-center text-xd sm:text-sm py-2.5">{e.username}</li>
                                            <li className="basis-2/5 text-[#6f809a] font-bold text-center text-xd sm:text-sm py-2.5">{e.title}</li>
                ...
                <div className="widget md:mb-5">
                    ...
                    <div className="w-full">
                        <ul className="flex py-4 text-sm justify-between border-b bg-[#f6f9fc]">
                            <li className="basis-[33%] text-[#6f809a] font-bold text-center text-xd sm:text-sm">작성자</li>
                            <li className="basis-2/5 text-[#6f809a] font-bold text-center text-xd sm:text-sm">내용</li>
                            <li className="basis-1/5 text-[#6f809a] font-bold text-center text-xd sm:text-sm">작성일</li>
                        </ul>
                        {
                            commentData && commentData.map((e,i)=>{
                                ...
                                return(
                                    <ul key={i} className="flex justify-between border-b last:border-0 items-center">
                                        <li className="basis-[33%] text-[#6f809a] font-bold text-center text-xd sm:text-sm py-2.5">{e.username}</li>
                                        <li className="basis-2/5 text-[#6f809a] font-bold text-center text-xd sm:text-sm py-2.5">{e.content}</li>
                                        <li className="basis-1/5 text-[#6f809a] font-bold text-center text-xd sm:text-sm py-2.5">{formatDate}</li>
                                    </ul>
                                )
                            })
